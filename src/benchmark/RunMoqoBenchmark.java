...
public class RunMoqoBenchmark {
	...
	*/
	...
	final static Optimizer[] optimizers = new Optimizer[] {
		...
		new TwoPhase(10, new ClimbingPhase(false, -1), new AnnealingPhaseSAIO(1, 0.1)),
	...
	public static void main(String[] args) throws Exception {
		...
		for (JoinType joinType : new JoinType[] {JoinType.MN, JoinType.MINMAX}) {
